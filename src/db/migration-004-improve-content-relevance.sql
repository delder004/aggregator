...
-- Tighten r/fintech query to require accounting terms
UPDATE sources SET config = '{"subreddit":"fintech","query":"(\"AI\" OR \"agentic\" OR \"automation\") AND (\"accounting\" OR \"audit\" OR \"bookkeeping\" OR \"tax\" OR \"CPA\")"}' WHERE id = 'reddit-fintech';
