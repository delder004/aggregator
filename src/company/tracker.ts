  ...
  const companies: Array<Omit<Company, 'articleCount'>> = [
    {
      id: 'intuit',
      name: 'Intuit',
      aliases: ['QuickBooks', 'QuickBooks AI', 'TurboTax'],
    ...
    },
    {
      ...
      description: 'Embedded accounting platform for SMB platforms',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      ...
      description: 'Accounting automation and managed accounting services',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      id: 'balanced',
      name: 'Balanced',
      aliases: ['Team Balanced'],
      website: 'https://www.teambalanced.com',
      description: 'AI-powered accounting platform',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      id: 'inkind',
      name: 'inKind',
      aliases: ['in Kind', 'inKind AI'],
      website: 'https://www.inkind.com',
      description: 'Restaurant fintech and capital platform',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      ...
      name: 'Karbon',
      aliases: ['Karbon HQ'],
      website: 'https://www.karbonhq.com',
      description: 'Practice management platform for accounting firms',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      ...
      description: 'AI-powered close management and accounting automation platform',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      id: 'zeni',
      name: 'Zeni',
      aliases: ['Zeni AI', 'Zeni Finance'],
      website: 'https://www.zeni.ai',
      description: 'AI-powered finance and bookkeeping platform for startups',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      ...
      description: 'AI-powered accounting and tax platform for cross-border startups',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      id: 'kintsugi',
      name: 'Kintsugi',
      aliases: ['Kintsugi AI', 'tryKintsugi'],
      website: 'https://trykintsugi.com',
      description: 'AI-powered sales tax compliance and automation',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      id: 'bluej',
      name: 'Blue J',
      aliases: ['Blue J AI', 'BlueJ', 'Blue J Legal'],
      website: 'https://www.bluej.com',
      description: 'AI-powered tax research and prediction platform',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
    ...
    },
    {
      id: 'blackore',
      name: 'Black Ore',
      aliases: ['Black Ore AI', 'BlackOre'],
      website: 'https://www.blackore.ai',
      description: 'AI tax automation and advisory platform for accounting firms',
      category: null,
      categorySlug: null,
      fundingStage: null,
      logoUrl: null,
