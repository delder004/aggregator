...
- [1E] — PR pending — Add homepage Jobs preview showing latest 5 open roles with title, company, location, and link to full `/jobs` page; uses responsive auto-fit grid (1 col on mobile, multi-col on desktop) positioned after spotlight sections and before Latest feed. — 2026-05-08
